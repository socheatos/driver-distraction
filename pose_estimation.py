...
class Pose():
    ...
    def estimate(self,detection,camera,allpts=False):
        ...
        _,rotation, translation = cv2.solvePnP(model_points, image_points,camera.intrinsic, 
        ...
        cv2.putText(camera.img, "pitch: " + str(np.round(self.pitch,2)), (50, 375), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 255), 2)
        cv2.putText(camera.img, "yaw: " + str(np.round(self.yaw,2)), (50, 400), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 255), 2)
        cv2.putText(camera.img, "roll: " + str(np.round(self.roll,2)), (50, 425), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 255), 2)
